    ...
    <section className="about">
      <div className="about-wrapper">
        ...
        <div>
          ...
          <p>{T("memberName7")}: <span><a href="mailto:antwerp@blackhistorymonth.be?subject=Hello&body=Hello BHM Antwerp!...">Audrey Ikirezi, Merryl Njimegni, Cheikh Niang, Nico Hillé, Sophie Gallant, Jason-Louise Graham, Uwera Kathy Franckaerts, Eyram Amavi and Awula Cole</a></span></p>
          <br/>
          <p>{T("memberText")}</p>
        </div>
      </div>
